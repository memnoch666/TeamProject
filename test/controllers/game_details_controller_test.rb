...
class GameDetailsControllerTest < ActionController::TestCase
  ...
  test "should create game_detail" do
    assert_difference('GameDetail.count') do
      post :create, game_detail: { game_id: @game_detail.game_id, question_id: @game_detail.question_id, status_id: @game_detail.status_id }
    end
  ...
  test "should update game_detail" do
    patch :update, id: @game_detail, game_detail: { game_id: @game_detail.game_id, question_id: @game_detail.question_id, status_id: @game_detail.status_id }
    assert_redirected_to game_detail_path(assigns(:game_detail))
  end
